...
LABEL org.opencontainers.image.description="VioxDotNet Music Server system"
...
# Config
RUN mkdir -p /etc/golibrespot /music /data/golibrespot /data/snapserver
