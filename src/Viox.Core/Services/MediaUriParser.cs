...
{
    private static readonly string[] validSources = ["spotify", "tunein", "radiobrowser", "podverse"];
    private static readonly string[] validTypes = ["album", "track", "episode", "podcast", "show", "station", "playlist", "link"];
